...
// SELECT the donors information based on the matchedid for the current user
$stmt = $pdo->prepare("
                    ...
                    <div class="row">
                        ...
                        <div class="wrapper list-group-horizontal">
                            ...
                            while ($row = $stmt->fetch()) {
                                ...
                                <div class="list-group-item list-group-item-action col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 roundCornersAll">
                                    <div id="container-1" class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                                ...
                                <!-- buttons -->
                                <div id="container-2" class="col-3 col-sm-4 col-md-4 col-lg-4 col-xl-4 float-right addPadding">
                                    <button type="button">
