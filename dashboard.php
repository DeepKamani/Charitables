        ...
        <main>
            <section class="container" id="app">
                ...
                <div class="tab-content">
                    <div id="donor" class="container tab-pane <?php echo ($_SESSION['role'] == '2' ? "active" : ""); ?> center"><br>
                    ...
                    <div id="recipient" class="container tab-pane <?php echo ($_SESSION['role'] == '1' ? "active" : ""); ?> center"><br>
                        <div class="list-group-horizontal">
                            <?php
                            while ($row = $r1->fetch()) {
                                ?>
